...
console.log ("The amount of cash to pay off debit is " + cashOnHand);//User's answer with a context string.
    ...
    if (cashOnHand === "") { //if statement if user does not enter a vaue.
...
alert ("You will have " + debtToCash + " left in debt once you use all available cash to pay down your debt");//alert the user of the amount of debt left after the paydown
...
//estabish a logical operator if user enters 0 for the amount of debt or the number of cards
